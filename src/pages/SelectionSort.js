...
const SelectionSort = () => {
  ...
  const startSorting = async () => {
    ...
    await sortingAlgorithms.selectionSort(array, speed, updateState);
  };
      ...
      <div className="max-w-6xl mx-auto">
        <ScrollAnimationWrapper>
          <h1 className="text-4xl font-bold text-center mb-8">
            <span className="bg-gradient-to-r from-green-300 via-emerald-300 to-white bg-clip-text text-transparent">
